...
def heat_map_yrs(preds, targs, start, end, perc):
...
figure1 = plt.figure()
title = 'Accuracy by Year - 1980+'
plt.title(title)
plot_by_year(te_rangeT, preds_range, 0)
plt.show()

figure2 = plt.figure()
title = 'Heatmap of Prediction vs Actual - 1980+'
plt.title(title)
heat_map_yrs(preds_range, te_rangeT, start, end - 1, False)
plt.show()

figure3 = plt.figure()
title = 'Heatmap of Prediction vs Actual %s - 1980+'
plt.title(title)
heat_map_yrs(preds_range, te_rangeT, start, end - 1, True)
plt.show()
